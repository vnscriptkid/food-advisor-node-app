...
var _bling = __webpack_require__(/*! ../js/modules/bling */ "./public/js/modules/bling.js");

var _autocomplete = __webpack_require__(/*! ../js/modules/autocomplete */ "./public/js/modules/autocomplete.js");

var _autocomplete2 = _interopRequireDefault(_autocomplete);

var _typeAhead = __webpack_require__(/*! ../js/modules/typeAhead */ "./public/js/modules/typeAhead.js");

var _typeAhead2 = _interopRequireDefault(_typeAhead);

var _ajaxHeart = __webpack_require__(/*! ../js/modules/ajaxHeart */ "./public/js/modules/ajaxHeart.js");

var _ajaxHeart2 = _interopRequireDefault(_ajaxHeart);
...
(0, _bling.$$)('form.heart').on('submit', _ajaxHeart2.default);

/***/ }),

/***/ "./public/js/modules/ajaxHeart.js":
/*!****************************************!*\
  !*** ./public/js/modules/ajaxHeart.js ***!
  \****************************************/
/*! no static exports found */
...
function ajaxHeart(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        _this.querySelector('button').classList.toggle('heart--active');
...
function dataToHtml(arr) {
    return arr.map(function (e) {
        return '<a href="/store/' + e.slug + '">' + e.name + '</a>';
    }).join('');
}
